...
const logo = 'https://cdn.jsdelivr.net/gh/netcloth/official-website@v0.2.6/src/assets/logo.png';
													...
													<div className={style.down_apple}>
														<div className={style.down_pop}>
															<div className={style.down_pop_left}>
																...
																<a
																	href="https://cdn.jsdelivr.net/gh/netcloth/official-website@v0.2.6/src/assets/netcloth1.1.2.apk"
																	download="netcloth-v1.1.2.apk"
																>
																	{_t('download.click')}
																</a>
															</div>
