...
const logo = 'https://cdn.jsdelivr.net/gh/netcloth/official-website@v0.3.7/src/assets/logo.png';
													...
													<div className={style.down_apple}>
														<div className={style.down_pop}>
															<div className={style.down_pop_left}>
																...
																<a
																	href="http://47.52.103.194/netcloth1.2.0.apk"
																	download="netcloth1.2.0.apk"
																>
																	{_t('download.click')}
																</a>
															</div>
