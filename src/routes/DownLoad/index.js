...
class DownLoad extends React.Component {
  ...
  renderDownload() {
    if (this.checkAngent()) {
      return (
        <a href="https://cdn.jsdelivr.net/gh/netcloth/official-website@v0.0.6/src/assets/netcloth0.2.0.apk" download="netcloth-v0.2.0.apk">本地下载</a>
      )
    } else {
      return (
        <Link to="install">本地下载</Link>
      )
    }
  }
